  ...
  return (
    <div className="faq-section">
      ...
      <div className="faq mb-6">
        ...
        <p className="text-gray-600">
          Actualmente, puedes verificar entradas para eventos deportivos de futbol. Estamos trabajando para expandir
          nuestra base de datos y ofrecer más opciones en el futuro.
        </p>
      </div>
